...
The published page is fully functional: every chart, the indicator dropdown,
the causes/risks toggle, the table views and the CSV downloads all work. It
labels itself *Static snapshot* with the date it was built, so nobody mistakes
it for a live feed.
